# Проектирование роста данных, модели хранения и архивации
...
Для проекта используем базу данных **PostgreSQL**: российское ПО, активно развивается, хорошая работа с JSONB, которого в проекте много (варианты ответов и правильные ответы, ответы пользователей на тесты), разработчики имеют экспертизу в работе с этой БД.
...
Очевидно, что рост базы будет происходить скачкообразно после подключения сервиса, когда менеджеры начнут заводить тесты для аттестации, создавать сессии для сотрудников, и особенно активно в периоды аттестаций, когда сотрудники начнут проходить тесты.
...
## Стратегии бэкапа, репликации, кластеризации
